...
public class RestaurantNoLoop {
	...
	public static void main(String[] args) {
		...
		System.out.println("For the meal price of " + nf.format(mealPrice) + " and with a " + TAX_RATE
				+ "% tax rate and a " + TIP_PERCENT + "% tip:"+ "\nThe tax is " + nf.format(chargedTax) 
				+ "\nThe tip is " + nf.format(chargedTip) + "\nthe total comes to " + nf.format(total));
